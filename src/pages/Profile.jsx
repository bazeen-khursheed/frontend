...
<div className="h-[calc(100vh-88px)] bg-slate-100 flex overflow-hidden">
      ...
      <div className="w-32 h-32 rounded-full bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 flex justify-center items-center text-white text-5xl font-bold border-4 border-white absolute -bottom-16">      {user?.name?.charAt(0).toUpperCase()}
</div>
</div>
<div className="pt-15 pb-6 px-8">
       <h1 className="text-3xl font-bold text-center text-[#071a2f]">{user?.name}</h1>
       <p className="text-center text-gray-500 mt-1">Welcome to your profile</p>
