...
return (
    <>
      <Navbar />
        ...
        <h1 className="text-3xl font-bold mb-8">Wishlist ❤️</h1>

        {wishlistItems.length === 0 ? (<h2>No Wishlist Items</h2>) : (
          wishlistItems.map((item) => (
            <div
              ...
              <button onClick={() => removeWishlist(item._id)} className="bg-red-500 text-white px-4 py-2 rounded"> Remove</button>
              </div>
          ))
        )}
             </div>
